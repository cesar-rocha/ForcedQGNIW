...
\beq
\label{spec_forcing}
\Es(\hat{\xi_q^\star}\hat{\xi_q}) =  A \exp\big\{{-[(k^2+l^2)^{1/2}-k_f]^2/2\Delta_f^2}\big\}\com
\eeq
...
\beq
\label{norm_fq}
\frac{1}{(2\pi)^2}\iint\half(k^2 + l^2)\Es(\hat{\xi_q^\star}\hat{\xi_q}) \dd k \dd l=1\com
\eeq
...
\beq
\label{prediced_A}
\Es(\A) = \frac{\sigma_\phi^2}{2\gamma}\com
\eeq
